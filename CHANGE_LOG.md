...
- Fix the version in the makelove configuration
...
- Rename the Ui:player_position() method to player_move_direction
...
- Rename the physics.make_collider() function
